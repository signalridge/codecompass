...
mod tests {
    ...
    #[test]
    fn test_codecompassignore_basic_patterns() {
        let dir = create_temp_project(&[
            ("src/main.rs", "fn main() {}"),
            ("src/generated.rs", "// generated"),
            ("tests/test.rs", "// test"),
            (".codecompassignore", "tests/\n"),
        ]);
        ...
        assert!(
            ...
            "tests/ should be ignored by .codecompassignore"
        );
    }

    #[test]
    fn test_codecompassignore_negation_pattern() {
        // .codecompassignore with negation: ignore all files in tests/ except tests/important.rs
